 ...
 document.getElementById('cupon-input-fild').addEventListener('keyup', function(e){
   ...
   document.getElementById('buss').addEventListener('click',function(){
        ...
        function remove(element){
           ...
           document.getElementById("input-field1").addEventListener('keyup',function(e){
               let input1 = e.target.value;
                console.log(input1);
                
            if( input1 !== 'text' ){
                
                document.getElementById("input-field2").addEventListener('keyup',function(e){
                    const input2 = e.target.value;
                    console.log(input2);
                    if( input2 !== ' ' ){
                       
                        document.getElementById("input-field3").addEventListener('keyup',function(e){
                            const input3 = e.target.value;
                            console.log(input3);
                            if( input2 !== ' ' ){
                                document.getElementById('btn-next').removeAttribute('disabled');
                            }
                            else {
                                document.getElementById('btn-next').setAttribute('disabled',false)
                            }
                       })
